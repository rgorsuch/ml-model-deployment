...
os.chdir("/Users/ryan.gorsuch/dev/ml/ml_classification")
...
new_prediction_probability = classifier.predict_proba(sc.transform(np.array([[40,20000]])))[:,1]

new_pred = classifier.predict(sc.transform(np.array([[42,50000]])))

new_prediction_probability = classifier.predict_proba(sc.transform(np.array([[42,50000]])))[:,1]
